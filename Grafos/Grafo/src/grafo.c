...
int grafo_criar_direcionado(Grafo *grafo, size_t vertices, int direcionado) {
    ...
    grafo->matriz = memoria_alocar_vetor_zero(vertices, sizeof(*grafo->matriz));
    ...
    for (size_t i = 0; i < vertices; ++i) {
        grafo->matriz[i] = memoria_alocar_vetor_zero(vertices, sizeof(*grafo->matriz[i]));
...
int grafo_bfs(const Grafo *grafo, size_t inicio, size_t *ordem, size_t capacidade, size_t *visitados) {
    ...
    int *visitado = memoria_alocar_vetor_zero(grafo->vertices, sizeof(*visitado));
    size_t *fila = memoria_alocar_vetor_zero(grafo->vertices, sizeof(*fila));
...
int grafo_ordenacao_topologica(const Grafo *grafo, size_t *ordem, size_t capacidade, size_t *tamanho_ordem) {
    ...
    size_t *grau_entrada = memoria_alocar_vetor_zero(grafo->vertices, sizeof(*grau_entrada));
    size_t *fila = memoria_alocar_vetor_zero(grafo->vertices, sizeof(*fila));

...
| [Lista](./Lista.md) | Lista sequencial dinâmica, versão estática, busca e ordenação |
| [Listas encadeadas](./ListasEncadeadas.md) | Lista simplesmente encadeada e lista duplamente encadeada |
| [Fila](./Fila.md) | Fila circular (FIFO) dinâmica e versão estática com capacidade fixa |
| [Pilha](./Pilha.md) | Pilha sequencial (LIFO) dinâmica e versão estática com capacidade fixa |
| [Tabela Hash](./TabelaHash.md) | Tabela hash opaca com encadeamento separado |
...
| [AVL](./AVL.md) | Árvore AVL opaca com inserção, remoção, rotações e balanceamento automático |
| [Grafo](./Grafo.md) | Grafo direcionado/não-direcionado com matriz de adjacência, pesos positivos e algoritmos de grafos |
...
| [Segurança de memória](./SegurancaMemoria.md) | Contratos de alocação, destruição, overflow de tamanho e arquivos |
| [Política de nomes](./PadraoNomes.md) | Convenção para novos módulos sem acentos e sem espaços |
| [Roteiro de aulas](./RoteiroAulas.md) | Sequência semanal sugerida para disciplina |
